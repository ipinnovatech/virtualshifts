    ...
    <script type="text/javascript">
        ...
        function crear_area(){
            ...
            for(var i = 0; i < formulario.elements.length; i++){
                ...
                }else if($(campo).attr("id") == "cantidad"){                    
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo ($objSedes->has_value)?'modificar_sede.php':'crear_sede.php' ?>',
                data: form_area,
        ...
        <div class="page-region">
            <div class="page-region-content">                
                <h1>
                    ...
                    <?php echo ($objSedes->has_value)?'Editar':'Crear' ?><small class="on-right">Sede</small>
                </h1>                
                
                <form action="javascript: crear_area();" id="form_area">
                    <?php echo ($objSedes->has_value)?'<input type="hidden" name="id_sede" id="id_sede" value="'.$objSedes->array_sedes['S_ID'].'" />':''; ?>
                    <br />
                    <div class="span3 offset1" style="float: left; text-align: right; font-size: 12pt;">Nombre<span class="fg-red">*</span>:&nbsp;</div>
                    <div class="input-control text size4">                        
                        <input name="nombre" id="nombre" type="text" onkeydown="validar_inputs(this)" placeholder="Nombre" value="<?php echo ($objSedes->has_value)?$objSedes->array_sedes['S_NOMBRE']:''; ?>" />
                        <button class="btn-clear"></button>
                    </div>
                    <br />
                    <div class="span3 offset1" style="float: left; text-align: right; font-size: 12pt;">Cantidad encuestas:&nbsp;</div>
                    <div class="input-control text size4">                        
                        <input name="cantidad" id="cantidad" type="text" onkeydown="validar_inputs(this)" placeholder="Cantidad encuestas" value="<?php echo ($objSedes->has_value)?$objSedes->array_sedes['S_CANTIDAD_ENCUESTAS']:''; ?>" />
                        <button class="btn-clear"></button>
                    </div>
                    <br />
                    ...
                    <div class="input-control textarea size4">
                        <textarea id="descrip" name="descrip" onkeydown="validar_inputs(this)" placeholder="Descripci&oacute;n"><?php echo ($objSedes->has_value)?$objSedes->array_sedes['S_DESCRIPCION']:''; ?></textarea>
                    </div>
                    <br />
                    <button class="primary large offset6" type="submit">Guardar</button>                    
                </form>
