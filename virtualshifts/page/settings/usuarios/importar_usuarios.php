    ...
    <script type="text/javascript">
        ...
        if($estado!='0'){
            if($estado=="error"){
                ...
                ?>
                $.Notify({
                            content: "Usuarios cargados con exito.",
        ...
        <div class="page-region">
            <div class="page-region-content">                
                <h1>
                    ...
                    Importar<small class="on-right">Usuarios</small>
                </h1>
                
                <form action="subir_archivo.php" method="post" id="form_imp_pv" enctype="multipart/form-data">      
                    <br />
