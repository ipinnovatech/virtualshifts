...
//                    $("#ventanilla"+j).html('');
    ...
    function muestra_fotos(){
        $("#porta_carousel").css('display', 'block');
        ...
        setTimeout('muestra_video()', 120000);
    }

    function muestra_video(){
        $("#porta_carousel").css('display', 'none');
...
<body class="metro" style="width: 1400px;" style="background-color: white;" onload="initialize()">
    <div class="grid">
        <div class="row">
            <div class="tile-group three">
                <div id="tile1" class="tile triple bg-blue flipbox" style="padding-top: 20px;">
            ...
            <div class="span8">
                <div style="margin-top: 36px;">
                    <img src="<?php echo $objSedes->array_sedes['L_URL']; ?>" style="float:left; width:618px; height: 168px;" />
                </div>
                <div>
                    <?php if($muestra_video == 1){ ?>
                        ...
                        <div id="porta_carousel" style="display: none;">
                            <ul id="carousel" style="display: none;">
                                <?php foreach($array_imagenes as $imagen){ ?>
                                    <li><img height="349" width="488" src="<?php echo $imagen; ?>" /></li>
                                <?php
                                }
                                ?>
                            </ul>
                ...
                <audio id="audio_cambio">
                     <source src="http://ipvirtualmobile.com/virtualshifts/sonidos/sonido2.mp3" type="audio/mpeg" />
                </audio>
            </div>
        </div>
